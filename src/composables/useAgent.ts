...
const TOOL_LABELS: Record<string, string> = {
  ...
  get_guide: 'Reading the handbook',
  edit_elements: 'Editing elements',
  create_page: 'Creating a page',
  delete_page: 'Deleting a page',
  set_page_seo: 'Setting page SEO',
  get_settings: 'Reading project settings',
  update_settings: 'Updating project settings',
  update_collection: 'Updating a collection schema',
  delete_collection: 'Deleting a collection',
  list_media: 'Browsing the media library',
